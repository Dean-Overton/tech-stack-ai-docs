...
![My Dashboards Button Image](https://github.com/Dean-Overton/tech-stack-ai-docs/master/MyDashboards.jpg)
2. Next, click **Unlock Dashboard** (this is a safety feature to stop users from accidentally removing their tech stack from the dashboard) ![Unlock Dashboards Button Image](https://github.com/Dean-Overton/tech-stack-ai-docs/master/UnlockDashboards.jpg)
3. Following that, **input a prompt** you would like to begin searching and click **Enter**. Stack Sensai will find a customized and well-thought-out tech stack for your search. For example, *"A startup website for a finance app that tracks each of my bank accounts."* ![Search Gif](https://github.com/Dean-Overton/tech-stack-ai-docs/master/search.gif)
